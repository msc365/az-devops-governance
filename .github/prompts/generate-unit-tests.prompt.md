...
- Use reference scripts and tests from similar existing scripts as templates
  - src/res/example-script/main.ps1
  - src/res/example-script/tests/unit/example-script.Tests.ps1
...
**Always skip (Not Essential)**
- WhatIf support - framework-level functionality
- Logging functionality - non-functional
- Telemetry/analytics - non-functional
...
- Create folder structure tests/unit if needed
