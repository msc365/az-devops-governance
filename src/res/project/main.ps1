...
.PARAMETER Name
    Required. The name of the Azure DevOps project to create or update.
...
.PARAMETER Process
    Optional. The process template to use for the project. Valid values are 'Agile', 'Scrum', 'CMMI', and 'Basic'.

.PARAMETER SourceControl
    Optional. The type of source control to use for the project. Valid values are 'Git' and 'Tfvc'.

.PARAMETER Visibility
    Optional. The visibility of the project. Valid values are 'Private' and 'Public'.
...
param (
    ...
    [string]$DefaultTeam = ('{0} Team' -f $Name),

    [Parameter(Mandatory = $false)]
    [string]$Description = 'Default project generated by Azure DevOps Governance',
