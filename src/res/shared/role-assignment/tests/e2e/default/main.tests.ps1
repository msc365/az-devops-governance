<#
.SYNOPSIS
    Default properties end-to-end tests for Azure role assignment.

.DESCRIPTION
    This script executes end-to-end tests with default properties for Azure role assignment configuration.
