<#
.SYNOPSIS
    Default properties end-to-end tests for Azure DevOps resource group.

.DESCRIPTION
    This script executes end-to-end tests with default properties for an Azure DevOps resource group configuration.
