...
> **Note** <br>
> To reference the module, please use the following syntax `iac/ptn/authorization/role-assignment/rg-scope/main.bicep`.
...
```bicep
module roleAssignment 'iac/ptn/authorization/role-assignment/rg-scope/main.bicep' = {
