...
param (
    ...
    [Parameter()]
    [string]$TemplateFile = 'iac/ptn/authorization/role-assignment/sub-scope/main.bicep',

    [Parameter()]
    [string]$TemplateParameterFile = 'iac/ptn/authorization/role-assignment/sub-scope/params/main.bicepparam'
)
